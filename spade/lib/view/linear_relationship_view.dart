...
class LinearRelationshipView extends StatefulWidget {
  const LinearRelationshipView({
    super.key,
  ...
  @override
  State<LinearRelationshipView> createState() => _LinearRelationshipViewState();
}

class _LinearRelationshipViewState extends State<LinearRelationshipView> {
          ...
          return AnimatedBuilder(
            ...
            builder: (context, _) {
              final plotPaths = viewModel.analysisPlotPaths
                  .where((filePath) => path.basename(filePath).contains('_iv_analysis.'))
                  .toList();
                  ...
                  children: [
                    SideBar(
                      ...
                      linearRelationshipEnabled:
                        viewModel.hasEnabledDownstreamTabs,
                      linearRelationshipActive: true,
